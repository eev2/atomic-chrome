...
If nil, you need to call \\[atomic-chrome-send-buffer-text] manually."
  :type 'boolean
  :group 'atomic-chrome)
...
(defcustom atomic-chrome-delete-temp-file t
  "If non-nil, upon closing the connection, the temporary file that
is created is deleted."
  :type 'boolean
  :group 'atomic-chrome)
